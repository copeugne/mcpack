...
- PR #15 is open from `experiment/item-7-worldgen-audit` into `main`. Its remote head is still the rejected revision `e26129498e905174df2ccbc067db589c244685b1`; the corrected local commits and r7 evidence have not yet been pushed for the next review cycle.
- Item 7 final raw evidence is durably published at `https://github.com/copeugne/mcpack/releases/tag/item-7-raw-evidence-2026-09-04-r7`. The annotated tag resolves to corrected source revision `ca646c19ad772bd6de6a47f4dcb0fc5dc4b5cbfc`. All four assets passed descriptor-bound restore verification plus two independent remote downloads and hash checks. The first, r2, r3, and r4 releases remain preserved as superseded evidence or custody history. Tags r5 and r6 preserve unpublished failed attempts.
...
| 7 | `PASS`, delivery pending | Two fresh four-seed runs inspected 54,816 exact selected chunks. The 192 anomaly rows, 762 packaged structure restrictions, all 37 provider-component dispositions, 1,222 warning signatures, corrected 128-capture visual set, final r7 descriptor-bound restore-tested archives, complete 716-file world archive inventory, and 125-artifact completion receipt pass. The latest review findings were fixed. Fresh exact-SHA review, GitHub Codex review, merge, and delivered-ref verification remain. |
