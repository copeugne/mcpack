...
- PR #15 is open from `experiment/item-7-worldgen-audit` into `main`. Its remote head is still the rejected revision `e26129498e905174df2ccbc067db589c244685b1`; the corrected local commits and r4 evidence have not yet been pushed for the next review cycle.
- Item 7 final raw evidence is durably published at `https://github.com/copeugne/mcpack/releases/tag/item-7-raw-evidence-2026-09-04-r4`. The annotated tag resolves to corrected source revision `bb6dd928b4a95db085c2e44d50296b7152f2b74d`. All four assets passed restore verification plus two independent remote downloads and hash checks. The first, r2, and r3 releases remain preserved as superseded evidence or custody history.
- Exact-SHA local reviews at `97262a21b0b76c253f57e32b8665e48d0a63f822`, `8c7e7b8bb5db79d826b78cab5a678605a8b5fc23`, and `438260f40fd0d50ff5f087a2b8aac028d5a39927`, plus GitHub Codex reviews at `eed044337bed03dcd8893d369cef9e6b5e6fd483` and `e26129498e905174df2ccbc067db589c244685b1`, returned `REJECTED`. Their valid findings drove every current correction. The rejected reviews are preserved under `evidence/item-7/review/`. A fresh final-SHA review remains mandatory.
...
| 7 | `PASS`, delivery pending | Two fresh four-seed runs inspected 54,816 exact selected chunks. The 192 anomaly rows, 762 packaged structure restrictions, all 37 provider-component dispositions, 1,222 warning signatures, corrected 128-capture visual set, final r4 restore-tested archives, complete 716-file world archive inventory, and 125-artifact completion receipt pass. The latest GitHub review findings were fixed. Fresh exact-SHA review, GitHub Codex review, merge, and delivered-ref verification remain. |
