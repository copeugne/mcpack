...
- User-directed review proportionality (2026-09-10): prioritize a coherent, enjoyable modpack. Block delivery for consequential correctness defects, unsupported material conclusions, unmet current acceptance criteria, compatibility failures, crashes, corruption, security/privacy or multiplayer-safety risks. Treat optional precision, exhaustive descriptive detail, stylistic preferences and speculative edge cases as non-blocking suggestions. Findings must name the concrete consequence and smallest necessary fix. Apply the current amended specification, not superseded measurement obligations. This does not relax evidence honesty, reproducibility, backup integrity or required reviewed delivery.
