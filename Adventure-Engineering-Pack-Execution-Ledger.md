...
The first exact-SHA review at `97262a21b0b76c253f57e32b8665e48d0a63f822` rejected delivery. It found an ignored-JAR test dependency, archive path-swap races, missing Java-compatible locks and hardlink isolation in staging, permissive provider-evidence fields, two oversized modules, and overbroad quality commands. Commits `9d1ff11` through `b13344e`, followed by the versioned publication binding and corrected r2 evidence in `1dc67fe` and `4e6b440`, address those findings. Repository-level completion still requires a fresh exact-SHA review, a clean Codex review cycle, merge into `main`, and delivered-ref verification.
