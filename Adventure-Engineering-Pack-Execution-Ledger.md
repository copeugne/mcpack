...
**Current execution gate:** Item 11 local gate REOPENED for completed-cost finding 3963125325; narrow correction and PR37 delivery pending. Item 10 and the cross-item audit are COMPLETE through PR35/36.
...
**Status: `COMPLETE`, merged and delivered as `a0f2fc275d2e72081ee5a9200e8309f0e3e720a0`**
...
The corrected 128 derived inspection captures passed two independent visual review lanes against one read-only r4 restore. The packaged restriction audit inspected 762 provider structures, resolved 757 restrictions, and recorded five impossible restrictions, including three active IDAS compatibility variants with missing tags. Later exact-SHA reviews proved that restore publication and then pre-validation output-parent creation remained unsafe. Those reviews are preserved as rejected evidence. The final implementation requires existing no-follow output parents, publishes and rechecks the restored tree through pinned descriptors, publishes the receipt from a pinned parent, rejects scalar coercion, and rewinds directory descriptors before every scan. GitHub Codex then found that completion did not bind every raw warning and control source. Commit `fb901b1050f211cb88fe1fb9d074f5d7c1e17407` added exact source verification. A later GitHub review at `2863f2d01c7446fe757b54593ea311bcacf35adb` found that accepted analysis and repeat-comparison results were not rebuilt from their selected JSONL and that stale queued save output could satisfy the flush boundary. Commits `8345df7`, `d51d176`, and `dbec2ee` fix the source rebuilds and the first flush correlation boundary. Later review proved the preserved r11 logs still could not causally bind generic save messages to the issued command. The source-bound recovery reopened all 12 existing archived worlds without regenerating worldgen evidence, verified each preboot inventory and runtime identity, and captured unique marker-bounded flush sequences. The first concurrent r12 attempt is rejected for a port collision, an insufficient stop timeout, and interrupted process cleanup. The corrected sequential r13 run passed all 12 recoveries. Four immutable r14 release assets were restored file by file, published under tag `item-7-raw-evidence-2026-09-04-r14`, downloaded once as a complete fresh set, and rehashed. Their manifests, restore receipts, release receipt, tracked verification tools, independent 716-file world archive inventory, source-bound v3 save audit, and 138-artifact completion receipt are committed under `evidence/item-7/`. The local completion gate returns `PASS`.

Exact-SHA local reviews at `97262a21b0b76c253f57e32b8665e48d0a63f822`, `8c7e7b8bb5db79d826b78cab5a678605a8b5fc23`, `438260f40fd0d50ff5f087a2b8aac028d5a39927`, `5a5623fbe161c3ab1874c8184b8f9f1d0418c9cd`, and `708478ce925353d8cb64199df0fc47d69df6bdf5`, plus GitHub Codex reviews at `eed044337bed03dcd8893d369cef9e6b5e6fd483`, `e26129498e905174df2ccbc067db589c244685b1`, `fe55d451bf081341101fc541ead992113133ab5b`, and `2863f2d01c7446fe757b54593ea311bcacf35adb`, rejected earlier delivery candidates. Their findings drove clean-export, descriptor custody, record-locking, strict-schema, repository-binding, destination-publication, restore publication, output-parent safety, active mutation tests, packaged biome restrictions, raw world inventory, corrected surface analysis, module sizing, reproduction commands, source rebuilding, and flush-sequence binding. All rejected reviews and dispositions are preserved under `evidence/item-7/review/`. PR #15 later merged accepted head `a57a00cf59005f59ad4694e3c1b0c6acc644754e` as `a0f2fc275d2e72081ee5a9200e8309f0e3e720a0`; the fetched `origin/main` ref contains that head. Item 7 is complete.
...
**Status: `COMPLETE`; inventory gate, clean review and main delivery verified.**
[PR18](https://github.com/copeugne/mcpack/pull/18) merged reviewed head2023a22a
as326979dd2eee7da3f881f1316eb845fb16e8ea6b, verified in fetched `origin/main`.
It supersedes closed, unmerged PR17.
...
original refs, recovery tags, backups and both mappings retained. The final Codex
cycle completed clean with a bot thumbs-up and no new findings. Its exact review
and delivery references are in the evidence README. Current report:
...
**Status: `COMPLETE`.** [PR35](https://github.com/copeugne/mcpack/pull/35)
merged reviewed head `45ee6da1` as `d507573ead2c2740657129e9ee57a1410f420ed9`.
Fetched main contains the exact accepted head. The completed final Codex review
introduced no findings and returned a bot thumbs-up. The
[authoritative result](evidence/item-10/README.md) records sixteen accepted worlds,
eight matched pairs, 176 strata and 720,896 full selected chunks. Both failed
ocean-heavy control attempts remain preserved; no target reduction or tuning
...
**Status: `IN PROGRESS`; local exit gate REOPENED for completed-cost finding 3963125325.**
...
and report are integrated at `56bf88b5`. Final applicable validation passes 600
tests in 196.80 seconds; lint/types and clean-code v2 reproduction pass.
...
| 11 | Automated route opportunities/repetition | `IN PROGRESS` | Protocol v2 fixes anchor-filtered visibility; complete corrected matrix/report integrated. Completed-cost finding 3963125325 reopens the local gate; prior 600-test validation is historical until correction. PR37 delivery pending. Evidence: `evidence/item-11/README.md`. |
