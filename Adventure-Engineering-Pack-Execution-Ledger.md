...
| 8 | Structure-family inventory | `IN PROGRESS` | Working inventory delivered through `376e8e6`; family coverage and attributes remain incomplete. Registry raw custody, publication and downloaded restore delivered through `63cb1f8`, under `evidence/item-8/raw-custody/`. Full local gate, clean final Codex review and verified main merge remain required. |
