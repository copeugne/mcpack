...
| `moogs_structures-neoforge-1.21.1-alpha-3.0.0.jar` | `moog-generator-code`, `moog-nether-generator-code`, `pool-codecs` | Entry/registry capture 88bafe0 and callback/reload/command capture 5a83e4c delivered. Remaining: declared mixins and registry/service dispatch. Reuse existing generator/codec captures. |
