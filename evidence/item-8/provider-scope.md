...
| `moogs_structures-neoforge-1.21.1-alpha-3.0.0.jar` | `moog-generator-code`, `moog-nether-generator-code`, `pool-codecs` | Entry/registry capture 88bafe0 now delivered. Remaining: mixins, callback bootstrap targets, registry/service dispatch, trial-spawner reload and debug command. Reuse existing generator/codec captures. |
