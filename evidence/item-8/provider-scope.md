...
| `moogs_structures-neoforge-1.21.1-alpha-3.0.0.jar` | `moog-generator-code`, `moog-nether-generator-code`, `pool-codecs` | Entry/registry capture 88bafe0 and callback/reload/command capture 5a83e4c delivered. Declared mixins delivered in a7af1d6. Remaining direct boundaries: registry/service dispatch, MixinUtils, EnhancedBeardifierHelper and DebugFlags. Reuse existing generator/codec captures. |
