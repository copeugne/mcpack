# C2ME declared hooks: c2me-opts-chunkio-remaining-hooks
...
10b112f245ed11b00a9d563c044c0c984c72e6808a56b7b3d182c3631c204860

```sh
uv run -m tools.inspect_item8_pool_elements --archive c2me-neoforge-mc1.21.1-0.3.0+alpha.0.93.jar --nested-archive META-INF/jars/c2me-opts-chunkio-mc1.21.1-0.3.0+alpha.0.93.jar --class-name com/ishland/c2me/opts/chunkio/mixin/hide_sync_disk_writes_behind_flag/MixinRegionBasedStorage.class --class-name com/ishland/c2me/opts/chunkio/mixin/limit_nbt_cache/MixinStorageIoWorker.class --output evidence/raw/item8/c2me-opts-chunkio-remaining-hooks-r1
```
...
Hooks change synchronous disk-write selection and pending NBT cache flushing. These operate on existing chunk data.
