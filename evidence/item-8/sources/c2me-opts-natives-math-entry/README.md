# C2ME module initialization: c2me-opts-natives-math-entry
...
ffa2240d3f841caae0a20cf0fca39e846b2e5e5591b5a80ca845066b7000d0fe

```sh
uv run -m tools.inspect_item8_pool_elements --archive c2me-neoforge-mc1.21.1-0.3.0+alpha.0.93.jar --nested-archive META-INF/jars/c2me-opts-natives-math-mc1.21.1-0.3.0+alpha.0.93.jar --class-name com/ishland/c2me/opts/natives_math/ModuleEntryPoint.class --output evidence/raw/item8/c2me-opts-natives-math-entry-r1
```
...
Reads native math enablement using the existing config accessor.
