# C2ME module initialization: c2me-server-utils-entry
...
de0db2d239411913a69f3b77ce26876c2d3d4e0694604a639f634298162aeccb

```sh
uv run -m tools.inspect_item8_pool_elements --archive c2me-neoforge-mc1.21.1-0.3.0+alpha.0.93.jar --nested-archive META-INF/jars/c2me-server-utils-mc1.21.1-0.3.0+alpha.0.93.jar --class-name com/ishland/c2me/server/utils/ModuleEntryPoint.class --output evidence/raw/item8/c2me-server-utils-entry-r1
```
