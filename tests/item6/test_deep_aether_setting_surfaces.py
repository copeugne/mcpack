...
SYSTEM = "Deep Aether"
FILES = [
    "config/cristellib/deep_aether/structure_placement_config.json5",
    "config/cristellib/deep_aether/structure_toggle_config.json5",
]


def test_deep_aether_surfaces_reproduce_all_16_source_leaves() -> None:
...
def test_deep_aether_files_are_system_owned_and_audited() -> None:
...
def test_deep_aether_surface_mutation_is_rejected(tmp_path: Path) -> None:
