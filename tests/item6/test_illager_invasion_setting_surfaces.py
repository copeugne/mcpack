...
def test_illager_invasion_surfaces_reproduce_all_21_source_leaves() -> None:
    ...
    assert [len(surface["leaves"]) for surface in surfaces] == [16, 5]


def test_illager_invasion_files_are_system_owned_and_audited() -> None:
...
def test_illager_invasion_surface_mutation_is_rejected(tmp_path: Path) -> None:
