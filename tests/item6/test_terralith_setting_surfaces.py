...
def test_terralith_surfaces_reproduce_all_47_source_leaves() -> None:
    ...
    assert [len(surface["leaves"]) for surface in surfaces] == [21, 26]


def test_terralith_files_are_system_owned_and_audited() -> None:
...
def test_terralith_surface_mutation_is_rejected(tmp_path: Path) -> None:
